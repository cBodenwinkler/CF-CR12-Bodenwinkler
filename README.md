## CR12-Bodenwinkler-traveler

#### Folder - cr12_Bodenwinkler_traveler.zip:
```
- 'unzip' into themes folder of your WP Project;
...
- Widgets can be implemented on single.php and on footer.php;
